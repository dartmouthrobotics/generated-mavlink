...
static void mavlink_test_direct_motor_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_DIRECT_MOTOR_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_direct_motor_control_t packet_in = {
        17235,17339,17443,17547,17651,17755,17859,17963
    };
    mavlink_direct_motor_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        packet1.motor5 = packet_in.motor5;
        packet1.motor6 = packet_in.motor6;
        packet1.motor7 = packet_in.motor7;
        packet1.motor8 = packet_in.motor8;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_DIRECT_MOTOR_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_DIRECT_MOTOR_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_direct_motor_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_direct_motor_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_direct_motor_control_pack(system_id, component_id, &msg , packet1.motor1 , packet1.motor2 , packet1.motor3 , packet1.motor4 , packet1.motor5 , packet1.motor6 , packet1.motor7 , packet1.motor8 );
    mavlink_msg_direct_motor_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_direct_motor_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.motor1 , packet1.motor2 , packet1.motor3 , packet1.motor4 , packet1.motor5 , packet1.motor6 , packet1.motor7 , packet1.motor8 );
    mavlink_msg_direct_motor_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_direct_motor_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_direct_motor_control_send(MAVLINK_COMM_1 , packet1.motor1 , packet1.motor2 , packet1.motor3 , packet1.motor4 , packet1.motor5 , packet1.motor6 , packet1.motor7 , packet1.motor8 );
    mavlink_msg_direct_motor_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_direct_motor_control(system_id, component_id, last_msg);
}
